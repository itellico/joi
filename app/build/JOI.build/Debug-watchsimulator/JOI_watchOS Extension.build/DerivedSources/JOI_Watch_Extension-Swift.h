...
#ifndef JOI_WATCH_EXTENSION_SWIFT_H
#define JOI_WATCH_EXTENSION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="JOI_Watch_Extension",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC19JOI_Watch_Extension18WatchSessionClient")
@interface WatchSessionClient : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

@class WCSession;
@class NSString;
@interface WatchSessionClient (SWIFT_EXTENSION(JOI_Watch_Extension)) <WCSessionDelegate>
